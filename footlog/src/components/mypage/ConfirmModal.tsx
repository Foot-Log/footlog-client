...
export default function ConfirmModal(props: ConfirmModalProps) {
  ...
  return (
    <main className="fixed inset-0 z-50 flex bg-black bg-opacity-50">
      <section className="rounded-confirmModal absolute left-59pxr top-278pxr flex h-202pxr w-276pxr flex-col items-center gap-24pxr bg-white pl-12pxr pt-32pxr">
